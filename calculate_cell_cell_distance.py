...
if __name__ == '__main__':
    ...
    n_components=args.c
    print("Start to calculate cell-cell distances...")
    print("The number of principle components is",n_components)
    start=datetime.datetime.now()
    features.get_cell_cell_distance(sim_info, features_dir, n_components=n_components)
